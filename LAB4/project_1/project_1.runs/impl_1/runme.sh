...
HD_PWD='C:/Users/Sam Bishop/Desktop/git/ECE4250/LAB4/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder4Bench.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Adder4Bench.tcl -notrace
