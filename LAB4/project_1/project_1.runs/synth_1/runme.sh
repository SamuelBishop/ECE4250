...
HD_PWD='C:/Users/Sam Bishop/Desktop/git/ECE4250/LAB4/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder4Bench.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adder4Bench.tcl
